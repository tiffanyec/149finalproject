...
class ControlStamped {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ControlStamped(null);
  ...
  static datatype() {
    ...
    return 'crazyflie_msgs/ControlStamped';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'e85f24c467a6496a2e0c3b92ff0fe75d';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ControlStamped(null);
